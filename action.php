...
<div class="container" style="margin-right:3vw;">
<div class="row">
<div class="col-md-3">
<div class="card">
  <img src="film1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Trolls World Tour</h5>
    <p class="card-text">Beli tiket sebelum kehabisan.</p>
...
<div class="col-md-3">
<div class="card">
  <img src="film2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    ...
    <a href="#" class="btn btn-primary">Rp.45.000</a>
    <a href="buy4.php" class="btn btn-success">Buy</a>
  </div>
</div>
</div>
<div class="col-md-3">
<div class="card">
  <img src="film3.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    ...
    <a href="buy5.php" class="btn btn-success">Buy</a>
  </div>
</div>
</div>
</div>
