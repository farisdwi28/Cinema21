<!DOCTYPE html>
    ...
    <h1><span class="badge badge-dark">DATA PEMBELIAN</span></h1>
    </div>
    </div>
    </div>
    <div class="container">
    ...
    <tr>
            ...
            <td><?php echo $d['Film'];?></td>
            <td><?php echo $d['Ticket'];?></td>
            <td>
            <a href='buy1.php?ID="<?php echo $d['ID'];?>"'><button type="button" class="btn btn-dark">Tambah</button></a>
